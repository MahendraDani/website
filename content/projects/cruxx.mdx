---
name: CruxxAI
abstract: Chrome extension and API that makes reading online easier. Hover over any link, click Summarize, and get a quick, clear summary of the website—perfect for saving time and staying informed.
...
links:
  [
    ...
    {
      title: "Source",
      url: "https://github.com/MahendraDani/cruxxai",
      type: "github",
    },
  ]
...
CruxxAI is a Chrome extension and API that makes reading online easier. Hover over any link, click Summarize, and get a quick, clear summary of the website—perfect for saving time and staying informed.
...
fetch(
  "https://api.danimahendra0904.workers.dev/cruxx/summarize?url=<website_url>",
  requestOptions
)
...
fetch(
  "http://localhost:8787/cruxx/summarize/all?url=<website_url>",
  requestOptions
)
  .then((response) => response.text())
  .then((result) => console.log(result))
