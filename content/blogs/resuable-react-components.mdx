...
This process can be break down into three steps :
...
<Tabs defaultValue="preview">
  ...
  <TabsContent value="preview">
   <main className="p-4" style={{height : "20rem"}}>
     <div className="flex justify-between items-center flex-wrap" style={{"marginTop" : "3rem"}}>
    ...
    export default function Page(){
      return (
        <div className="flex justify-between items-center flex-wrap">
          ...
          <Button size={"md"} colour={"green"}>Button</Button>
          <Button size={"md"} colour={"purple"}>Button</Button>
          <Button size={"md"} colour={"red"}>Button</Button>
          <Button size={"md"} colour={"yellow"}>Button</Button>
      </div>
        <br/>
      <div className="flex justify-between items-center flex-wrap">
        <Button size={"md"} colour={"cyan"} radius={"lg"}>Button</Button>
        <Button size={"md"} colour={"green"} radius={"lg"}>Button</Button>
        <Button size={"md"} colour={"purple"} radius={"lg"}>Button</Button>
        <Button size={"md"} colour={"red"} radius={"lg"}>Button</Button>
        <Button size={"md"} colour={"yellow"} radius={"lg"}>Button</Button>
      </div>
        <br/>
      <div className="flex justify-between items-center flex-wrap">
        <Button size={"sm"} colour={"cyan"} radius={"lg"}>Button</Button>
        <Button size={"sm"} colour={"green"} radius={"lg"}>Button</Button>
        <Button size={"sm"} colour={"purple"} radius={"lg"}>Button</Button>
        <Button size={"sm"} colour={"red"} radius={"lg"}>Button</Button>
        <Button size={"sm"} colour={"yellow"} radius={"lg"}>Button</Button>
      </div>
      )
    }
    ```
...
<Tabs defaultValue="preview">
  ...
  <TabsContent value="preview">
   <main className="p-4 flex justify-center items-center" style={{height : "20rem"}}>
